...
class StockCrossOverSignalTest(unittest.TestCase):
    ...
    def _generate_timestamps(self, price_list):
        ...
        self._generate_timestamp_for_date(datetime(2014, 2, 13) - timedelta(i), price_list[len(price_list) - i - 1])
    ...
    def test_stock_with_no_data_returns_neutral(self):
        ...
        self.assertEqual(StockSignal.neutral, self.goog.get_crossover_signal(date_to_check))
